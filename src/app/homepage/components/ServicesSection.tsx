            ...
            >
              ...
              <div className="relative z-10 p-7 h-full flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="font-heading font-bold text-xl text-[#161412] mb-3">
                    {service.title}
                  </h3>
                ...
                <div className="flex flex-wrap gap-2 mt-4 items-center">
                  ...
                  <Link
                    href={service.href}
                    className="ml-auto text-[#0D9E8F] opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1 text-xs font-semibold font-heading hover:underline"
                  >
